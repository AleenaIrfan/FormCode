...
completed_session = pd.read_csv('completed_sessions.csv.gz', compression='gzip')
abandoned_session = pd.read_csv('abandoned_sessions.csv.gz', compression='gzip', low_memory=False)
