...
X = np.array(merged_data[['Time_Taken_till_Step','Backspaces_till_Step','Clicks_till_Step','Text_Field_Count_till_Step', 'Field_Returns_till_Step']]) #add 'Time_Taken_Step1', 'Clicks_Step1' for other steps
